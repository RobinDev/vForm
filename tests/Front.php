...
$fields = [
    ...
    'radioB2'   => ['type' => 'radio', 'options' => [ 1 => 'Forever', 2 => 'Just For Five Minuts'], 'required', 'fieldFormat' => '<label class="btn btn-primary :active"><input type="radio" id=":name" name=":name" value=":value">:plainLabel</label>', 'encaps' => '<p>:label:input</p>', 'label' => 'How Many ?'],
];
